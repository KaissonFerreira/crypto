...
Welcome to ``crypto_01`` contributor's guide.
...
If you experience bugs or general issues with ``crypto_01``, please have a look
...
You can help improve ``crypto_01`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``crypto_01`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``crypto_01``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n crypto_01 python=3 six virtualenv pytest pytest-cov
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/crypto_01.git
    cd crypto_01
...
#. Install |pre-commit|_::
   ...
   ``crypto_01`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/crypto_01
.. _issue tracker: https://github.com/<USERNAME>/crypto_01/issues
.. <-- end -->
